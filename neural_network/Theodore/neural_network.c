...
neur_net *nn_new_instance(int num_inputs, int num_hid_lay, int num_hid_neur, int num_outputs)
{
    ...
    //    // |---------------------------| <- start oof memory allocation for a neur_net structure
    //
...
double const *nn_feedforward(neur_net const *nn, double const *inputs)
{   
    //TODO
    double const *w = neur_net->weights;
...
{
    //TODO modify functions according to our parameters
